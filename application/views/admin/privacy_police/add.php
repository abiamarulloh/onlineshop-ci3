<?= $this->session->flashdata("privacy_police");  ?>
<div class="container my-5">
    <div class="row">
        <div class="col-md-12">
            <h2>Publish Kebijakan Privasi</h2>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form action="" method="post">
                ...
                <button type="submit" class="btn btn-primary float-left mr-3">Publish Kebijakan Privasi</button>
            </form>
