                ...
                <div class="card mb-3" >
                    <div class="row no-gutters">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url(); ?>brand_edit/<?= $brand->id; ?>" class="btn btn-warning btn-sm m-2">Edit</a>
                            <a href="<?= base_url(); ?>brand_delete/<?= $brand->id; ?>" class="btn btn-danger btn-sm m-2">Delete</a>
                        </div>
                        </div>
                    </div>
                </div>
