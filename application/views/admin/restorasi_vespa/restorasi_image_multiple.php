<?= $this->session->flashdata('restorasi_image_thumnails'); ?>
<div class="container my-5">
    <div class="row">
        <div class="col-md-12 text-center font-weight-bold text-dark">
            <h2>Tambah data gambar thumbnails Restorasi</h2>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="file">Upload Banyak Gambar Thumbnails Restorasi</label>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="<?= base_url("restorasi_admin"); ?>" class="btn btn-outline-info"> <i  class="fas fa-angle-double-right"></i> kembali</a>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <div class="row my-5">
        ...
        <div class="col-md-3 my-2">
            <div class="card">
                <img src="<?= base_url("assets/admin/img/restorasi/restorasi_thumbnails/") . $thumnail->image_name; ?>"
                    class="card-img-top" alt="<?= $thumnail->image_name; ?>">
                <a href="<?= base_url("restorasi_image_multiple_delete/") . $thumnail->id; ?>"
