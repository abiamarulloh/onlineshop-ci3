<div class="container">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-6">
            <h5>List Category</h5>
            <hr>
            <?= $this->session->flashdata('product_category'); ?>
            <ul class="list-group">
                ...
                <?php else : ?>
                    ...
                    <?php foreach ($list_category as $category) :?>
                        <li class="list-group-item">
                            <?= $no++ . ". " . $category->name; ?>
                            <a href="<?= base_url("admin/ecommerce/delete_category/"). $category->id ?>" class="close btn btn-light" >
